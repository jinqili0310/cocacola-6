...
function displayBot()
{
	...
	// if(user_name == '') {
		setTimeout(function() {
		    postBotAnswer("Hi. This is Coca-Cola's chatbot powered by artificial intelligence. I am still learning so I might have difficulty understanding you sometimes, but I will answer your company-related questions.")
		}, 500);
	// }
}
