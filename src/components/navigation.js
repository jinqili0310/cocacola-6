 ...
 * @LastEditTime: 2020-11-06 20:12:47
 * @FilePath: /cocacola-6/src/components/navigation.js
 */
		...
		return (
			<Navbar collapseOnSelect className="navbar" expand="lg" fixed="top">
				<Navbar.Brand className="nav-logo">
					<a href="/cocacola-6/#/products/coca-cola">
						<img
							src={ccLogo}
							width="90.16"
							height="50"
					...
					<Navbar.Collapse id="basic-navbar-nav">
						<Nav className="mr-auto">
							<NavDropdown title="OUR BRANDS" id="basic-nav-dropdown">
								<BrowserRouter>
								<NavDropdown.Item href="/cocacola-6/#/products/coca-cola/">
									<img className="nav-cokes" src={navCoke} alt="nav-coke" />
								</NavDropdown.Item>
								<NavDropdown.Item href="/cocacola-6/#/products/coca-cola-zero-sugar/">
									<img className="nav-cokes" src={navZero} alt="nav-coke" />
								</NavDropdown.Item>
								<NavDropdown.Item href="/cocacola-6/#/products/coca-cola-energy/">
									<img className="nav-cokes" src={navEnergy} alt="nav-coke" />
								</NavDropdown.Item>
								<NavDropdown.Item href="/cocacola-6/#/products/coca-cola-flavors/">
									<img className="nav-cokes" src={navFlavor} alt="nav-coke" />
								</NavDropdown.Item>
								<NavDropdown.Item href="/cocacola-6/#/products/coca-cola-local-flavors/">
									<img className="nav-cokes" src={navLocal} alt="nav-coke" />
								</NavDropdown.Item>
								</BrowserRouter>
							</NavDropdown>
							<Nav.Link href="/cocacola-6/#/about-us/coca-cola-history/">HISTORY</Nav.Link>
						</Nav>
					</Navbar.Collapse>
				</div>
			</Navbar>
